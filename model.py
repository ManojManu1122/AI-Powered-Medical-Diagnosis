...
def classify(img):
    ...
    model_path = r"C:\Users\manoj\Manu\Capstone\Health_Vision_1\Health_Vision_1\all-in-one.h5"
...
def bone_net(img):
    ...
    lt = ["Normal",'Fractured']
    model_path = r"C:\Users\manoj\Manu\Capstone\Health_Vision_1\Health_Vision_1\fracture.h5"
    model = tf.keras.models.load_model(model_path, compile=False)
